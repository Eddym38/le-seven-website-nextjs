...
export const metadata: Metadata = {
  ...
  title: {
    default:
      "Le Seven | Restaurant Maison à Grenoble – Cuisine Française Généreuse",
  ...
  keywords: [
    ...
    "restaurant privatisation",
    "restaurant fête grenoble",
    "restaurant ouvert le dimanche",
    "restaurant avec options vegan",
    "restaurant avec options sans lactose",
    "cuisine franco-libanaise",
    "restaurant esplanade",
    "restaurant centre-ville grenoble",
    "cuisine méditerranéenne",
    "restaurant familial grenoble",
    "restaurant entre amis grenoble",
    "restaurant romantique grenoble",
    "restaurant décontracté grenoble",
  ],
